      ...
      <div className="bg-onx-black rounded-[24px] md:rounded-[40px] pt-16 md:pt-24 px-8 md:px-16 overflow-hidden max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-12 mb-4 md:mb-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-5 pr-0 md:pr-12">
            ...
            <p className="mt-6 text-base text-onx-white font-normal leading-[1.375]">
              ...
              <ul className="mt-6 flex flex-col gap-[17px]">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-base text-onx-white hover:text-onx-red transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-3 md:-ml-8 lg:-ml-16">
            ...
            <p className="mt-6 text-base text-onx-white leading-[1.375]">
