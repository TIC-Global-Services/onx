      ...
      <Container>
        <div className="mx-auto max-w-[900px] text-center flex flex-col items-center">
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-onx-near-black">
              BUILT FOR STABILITY, CONTROL, AND ABSOLUTE ACCURACY WHEN IT MATTERS MOST.
            </span>
          </div>

          <h2 className="text-[40px] sm:text-[38px] md:text-[42px] lg:text-[56px] font-bold uppercase leading-tight tracking-tight text-onx-near-black mb-12">
            OWN THE TARGET<br />CONTROL EVERY SHOT
          </h2>

          <p className="text-xs md:text-xs font-bold uppercase tracking-widest text-onx-black leading-wide max-w-[650px]">
