      ...
      <Container>
        <div className="mx-auto max-w-[900px] text-center flex flex-col items-center">
          ...
          <div className="mb-8 text-center">
            <span className="text-xs md:text-xs font-normal uppercase tracking-wider text-onx-near-black ">
          ...
          <p className="text-xs md:text-xs font-normal uppercase tracking-wider text-onx-black leading-wide max-w-[650px]">
            BUILT FOR THOSE WHO DEMAND ABSOLUTE CONTROL, RIFLE SHOOTING HERE IS WHERE FOCUS MEETS PRECISION—EVERY BREATH MEASURED, EVERY MOVEMENT STEADY, AND EVERY SHOT DELIVERED WITH INTENT. IT'S NOT JUST ABOUT HITTING THE TARGET, IT'S ABOUT MASTERING THE MOMENT AND OWNING EVERY SINGLE SHOT.
          </p>
